      ...
      {open && (
        ...
        >
          <motion.div
            ...
            className="w-full max-w-lg max-h-[calc(100dvh-2rem)] rounded-[var(--radius-xl)] border border-[var(--color-border)] bg-[var(--color-card)] shadow-[var(--shadow-xl)] overflow-hidden flex flex-col"
          >
            {/* Header */}
            <div className="flex items-center justify-between px-4 sm:px-5 py-4 border-b border-[var(--color-border)] shrink-0">
              ...
              <button
                onClick={onClose}
                aria-label="Fermer"
                className="w-7 h-7 rounded-[var(--radius-md)] flex items-center justify-center text-[var(--color-text-3)] hover:bg-[var(--color-bg-2)] hover:text-[var(--color-text)] transition-colors duration-[var(--dur-fast)] cursor-pointer shrink-0"
              >
                <X className="w-4 h-4" />
              </button>
            </div>
            ...
            {/* Footer */}
            <div className="flex items-center justify-end gap-2 px-4 sm:px-5 py-3.5 border-t border-[var(--color-border)] bg-[var(--color-bg-2)] shrink-0">
